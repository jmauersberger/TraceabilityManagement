 ...
 * @generated
 */
public class GenericTraceLinkMetaModelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public GenericTraceLinkMetaModelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GenericTraceLinkMetaModelPackage.SATISFY: {
...
} //GenericTraceLinkMetaModelSwitch
